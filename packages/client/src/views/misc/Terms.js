...
function Terms() {
  return (
    <div>
      ...
      <p>Welcome to PatientProgress!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of PatientProgress's Website, located at https://app.patientprogress.ca.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use PatientProgress if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing PatientProgress, you agreed
        to use cookies in agreement with the PatientProgress's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, PatientProgress and/or its licensors own the
        intellectual property rights for all material on PatientProgress. All
        intellectual property rights are reserved. You may access this from
        PatientProgress for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from PatientProgress</li>
        <li>Sell, rent or sub-license material from PatientProgress</li>
        <li>Reproduce, duplicate or copy material from PatientProgress</li>
        <li>Redistribute content from PatientProgress</li>
      </ul>
      ...
      <p>
        ...
        PatientProgress does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of PatientProgress,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, PatientProgress
      ...
      <p>
        PatientProgress reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant PatientProgress a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of PatientProgress; and (d) the
      ...
      <p>
        ...
        e-mail to PatientProgress. Please include your name, your organization
      ...
      <p>
        No use of PatientProgress's logo or other artwork will be allowed for
